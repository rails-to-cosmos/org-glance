...
#+END_SRC
*** TODO Tests
**** Return must contain no duplicates                                       :Test:
***** DONE Predicate
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** Proper handling lambda with nil return                                  :Test:
***** DONE Predicate
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** Input must handle scopes of types: buffer, fun, filename
**** Proper handle nil input
