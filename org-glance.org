...
** Run build                                                                   :build:
:PROPERTIES:
:HANDLER:  (progn (delete-file "tests.el") (delete-file "org-glance.el") (org-sbe "org-block-execute") (org-sbe "with-temp-org-buffer") (org-babel-tangle) (load-file "org-glance.el") (load-file "tests.el") (byte-compile-file "org-glance.el") (ert-run-tests-interactively "^org-glance-test/" "*org-glance-tests*"))
:END:
* Local Variables
# Local Variables:
