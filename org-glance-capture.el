...
(cl-defun org-glance-capture1 (tag title &key (callback nil) (template nil))
  (declare (indent 2))
  ...
  (let ((id (org-glance-tag:generate-id tag))
    ...
    (cl-flet ((prepare-finalize-hook ()
                (org-glance-headline1--from-string (buffer-string)) ;; should create graph of headlines in general
                ;; (goto-char (point-min))
