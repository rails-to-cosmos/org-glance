...
(ert-deftest org-glance-test:overview-keymap-bindings ()
  ...
  (let ((map org-glance-overview-mode-map))
    (dolist (binding `(("n" . ,#'org-next-visible-heading)
                       ("p" . ,#'org-previous-visible-heading)
                       ("f" . ,#'org-forward-heading-same-level)
                       ("b" . ,#'org-backward-heading-same-level)
                       ("," . ,#'beginning-of-buffer)
                       ("." . ,#'end-of-buffer)
                       ("RET" . ,#'org-glance-overview:materialize)
                       ("j" . ,#'org-glance-overview:open)
                       ("!" . ,#'org-glance-overview:open)
                       ("e" . ,#'org-glance-overview:extract)
                       ("a" . ,#'org-glance-agenda)
                       ("g" . ,#'org-glance-overview:refresh)
                       ("/" . ,#'org-glance-overview-filter)
                       ("q" . ,#'quit-window)))
