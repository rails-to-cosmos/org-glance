...
* Issues
** TODO [#A] data corruption in overview after sync relations
** TODO update relation title and status on visit
** TODO domains. domain borders. cross-domain classes.
** TODO implement headline aliases
** PENDING capture through materialization
:LOGBOOK:
...
** TODO multiple repetitive tasks of one project
** TODO repetitive tasks: clone subtasks
** TODO on materialize pull subtasks states
...
:END:
** TODO when i need to create a new class?
