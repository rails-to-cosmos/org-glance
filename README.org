...
* PENDING Refactor partitions
:LOGBOOK:
- State "PENDING"    from "STARTED"    [2023-01-07 Sat 19:37]
- State "STARTED"    from "TODO"       [2022-12-14 Wed 22:29]
:END:

- partition should only know its root location
- still should not be strongly connected to world
- manage its own wal
- one-to-many views

* TODO [#C] Changelog and in-memory changelog could be merged
* DONE Optimize fetch method
CLOSED: [2022-12-10 Sat 09:23]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-12-10 Sat 09:23]
:END:
* DONE View model should contain metadata from header
CLOSED: [2022-12-11 Sun 21:13]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-12-11 Sun 21:13]
:END:
* DONE View shouldn't know about the world
CLOSED: [2022-12-08 Thu 22:35]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-12-08 Thu 22:35]
:END:
* TODO [#C] Workflows
1. TODO Purchase Backpack
2. DONE → Add "Inventory" tag → Set "" todo state
* TODO Clear partitions
* TODO Don't save view header if nothing changed
* TODO [#A] Overview dimensions and mode                                        :feature:
* TODO [#C] Separate event logs                                                 :optimization:
* TODO Implement solvers for dimensions
* TODO Extract values from propertized and encrypted headlines
* TODO Remove empty dimensions
* DONE [#B] Delete headlines
CLOSED: [2022-11-19 Sat 11:58]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-11-19 Sat 11:58]
:END:
* TODO [#A] Relations
* TODO [#C] Import including attachments
