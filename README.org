...
* DONE refactor headline tests
CLOSED: [2022-09-28 Wed 12:37]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-09-28 Wed 12:37]
:END:
...
:END:
* DONE Fix mew and prepare to relations
CLOSED: [2022-09-02 Fri 11:20]
:LOGBOOK:
- State "DONE"       from "STARTED"    [2022-09-02 Fri 11:20]
- State "STARTED"    from              [2022-08-15 Mon 10:20]
:END:
* TODO filter store headlines [3/3]
:LOGBOOK:
...
** by relations (todo)
* DONE add tests on materialized offsets
CLOSED: [2022-09-02 Fri 11:21]
:LOGBOOK:
- State "DONE"       from              [2022-09-02 Fri 11:21]
:END:
* https://ftp.gnu.org/old-gnu/Manuals/elisp-manual-21-2.8/html_node/elisp_530.html
* DONE fix wal reversal
CLOSED: [2022-09-02 Fri 11:21]
:LOGBOOK:
- State "DONE"       from              [2022-09-02 Fri 11:21]
:END:
...
* DONE Optimize `org-glance-material-mode:commit`: sync only changed headlines
