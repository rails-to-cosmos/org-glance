...
** Wait-free
** Efficient reads
** Column filters (by *-p features and timestamps)
** Fulltext search
* Issues
** TODO Use https://github.com/alphapapa/makem.sh
** TODO Registries
:LOGBOOK:
- State "DONE"       from "STARTED"    [2022-04-11 Mon 11:31]
CLOCK: [2022-04-02 Sat 12:33]
- State "STARTED"    from "TODO"       [2022-04-02 Sat 12:33]
:END:
** TODO Overview [1/5]
